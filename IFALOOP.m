function IFALOOP(startL3, stopL3, numsL3,startL6, stopL6, numsL6,startW1, stopW1, numsW1, meshsize)
    ...
    filename = sprintf("data/results_%s_meshsize-%.0f_L3-%.0f-%.0f-%.0f_L6-%.0f-%.0f-%.0f_W1-%.0f-%.0f-%.0f.txt",t,meshsize*10000,startL3,stopL3,numsL3,startL6,stopL6,numsL6,startW1,stopW1,numsW1);
    ...
    for i = 1:numsL3
        for j = 1:numsL6
            for k = 1:numsW1
                ...
                str = sprintf("L3\t%.3f\tL6\t%.3f\tW1\t%.3f\tDB\t%.3f\tIMP\t%.5f\tmeshsize\t%0.5f\n", varL3(i),varL6(j),varW1(k),dbi,impedans,meshsize);
